...
class Template(object):
    def __init__(self):
        ...
        self.sub = rospy.Subscriber("uoct/stoplight/godclock", Int16MultiArray, self.thirty_sec)
        # self.pub = rospy.Subscriber("uoct/stoplight/godclock", Int16MultiArray, slef.sixty_sec)
        self.pub = rospy.Publisher("uoct/stoplight/north2south", Int16MultiArray, queue_size=7)
...
def main():
    ...
    print 'Spotlights at North-South on sync'
    rospy.spin()
