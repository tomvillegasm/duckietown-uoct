...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'surveillance' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomvillegasm/duckietown-uoct/catkin_ws/src/surveillance/${idir}'.  ${_report}")
    endif()
