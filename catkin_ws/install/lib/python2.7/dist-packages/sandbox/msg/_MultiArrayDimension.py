...
"""autogenerated by genpy from sandbox/MultiArrayDimension.msg. Do not edit."""
import sys
...
class MultiArrayDimension(genpy.Message):
  _md5sum = "c859bfffbf71660d86da49dca5a1f3c1"
  _type = "sandbox/MultiArrayDimension"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string type # cross, street, blink warning
string direction # norht2south, east2west, up2down
int16[] colors # [red,gree,blue,custom]
"""
  __slots__ = ['type','direction','colors']
