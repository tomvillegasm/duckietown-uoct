...
(cl:defmethod cl:initialize-instance :after ((m <MultiArrayDimension>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiArrayDimension)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sandbox-msg:<MultiArrayDimension> is deprecated: use sandbox-msg:MultiArrayDimension instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <MultiArrayDimension>))
...
(cl:defmethod direction-val ((m <MultiArrayDimension>))
...
(cl:defmethod colors-val ((m <MultiArrayDimension>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MultiArrayDimension>)))
  ...
  "c859bfffbf71660d86da49dca5a1f3c1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MultiArrayDimension)))
  "Returns md5sum for a message object of type 'MultiArrayDimension"
  "c859bfffbf71660d86da49dca5a1f3c1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MultiArrayDimension>)))
  ...
  (cl:format cl:nil "string type # cross, street, blink warning~%string direction # norht2south, east2west, up2down~%int16[] colors # [red,gree,blue,custom]~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MultiArrayDimension)))
  "Returns full string definition for message of type 'MultiArrayDimension"
  (cl:format cl:nil "string type # cross, street, blink warning~%string direction # norht2south, east2west, up2down~%int16[] colors # [red,gree,blue,custom]~%~%~%"))
